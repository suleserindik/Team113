...
public class C05_DateTimeFormatter {
    public static void main(String[] args) {
        ...
        /*
            ...
            Ancak bizim istedigimiz formata uygun olarak cevirmemize veya yazdirmamiza
            izin verir
        ...
        System.out.println(ldt); // 2023-03-09T22:03:03.871265200

        DateTimeFormatter dtf= DateTimeFormatter.ofPattern("d / M / yyyy");
        System.out.println(ldt.format(dtf)); // 9 / 3 / 2023
        ...
        DateTimeFormatter dft4= DateTimeFormatter.ofPattern("EEEE hh:mm a");
        System.out.println(ldt.format(dft4)); // Perşembe 10:16 ÖS
